...
const SideBar = (): JSX.Element => {
  return (
    <div className="bg-vektor-kontrollblue border-8 rounded-3xl w-23 sm:w-32 md:w-40 h-full flex flex-col items-center justify-start fixed overflow-y-auto overflow-x-hidden">
