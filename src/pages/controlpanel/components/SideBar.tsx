...
const linkData = [
  ...
  { to: "opptaksstatistikk", icon: <OpptaksstatistikkIcon />, name: "Opptaksstatistikk" },
...
const Icon: React.FC<IconProps> = ({ svg, name }) => {
  return (
    <div className="flex flex-col items-center justify-center my-2">
      <button type="button" className="bg-vektor-blue hover:bg-white rounded-full flex items-center justify-center w-8 h-8 sm:w-11 sm:h-11">
        {svg}
      </button>
...
const SideBar = (): JSX.Element => {
  return (
    <div className="bg-vektor-kontrollblue border-8 rounded-3xl w-24 sm:w-32 md:w-40 h-full flex flex-col items-center justify-start fixed overflow-y-auto overflow-x-hidden">
      <div
        className="bg-white rounded-full flex items-center justify-center mt-2 w-16 h-16 sm:w-24 sm:h-24"
      >
        <img
