...
const SideBar = (): JSX.Element => {
  return (
    <div className="min-w-min bg-vektor-kontrollblue border-8 rounded-3xl w-24 sm:w-32 md:w-40 min-h-min flex flex-col items-center justify-start overflow-y-auto overflow-x-hidden">
