...
const LoginPopup = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white flex p-7.5 rounded-lg justify-around max-w-2xl h-96 border-2 "
        id="popup"
      >
        ...
        <div className="mt-20 ml-5">
          <div>
            ...
            <input
              ...
              onFocus={() =>
                setimgClassName(
                  "flex flex-row mt-10 ml-4 transform duration-300",
                )
              }
          ...
          <div>
            ...
            <input
              ...
              onFocus={() =>
                setimgClassName(
                  "flex flex-row mt-36 ml-4 transform duration-300",
                )
              }
              onKeyDown={handleEnterLogIn}
            />
          ...
          <div>
            <p className="mob-message hidden text-red-500 font-semibold">
              {errorMessage}
            </p>
            <button
              type="button"
            ...
            <u className="text-blue-400 cursor-pointer">Glemt Passord?</u>
          </div>
        </div>
        <button
          className="btn btn-primary btn-square btn-outline relative text-2xl cursor-pointer mr-2 mt-2"
