  ...
  return (
    <div className="max-w-screen-lg mt-5 mb-20 mx-auto flex flex-col items-center">
      <TeamTemplate
        ...
        members={[{ name: "Ole Gunnar Røsholt Hovland", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/6261456bbbea9.jpeg", role: "Leder" },
          { name: "Ingeborg Aarnes", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/6356cd46ce6f9.jpeg", role: "Medlem" },
          { name: "Erik Mathisen", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/6356cd087286f.jpeg", role: "Medlem" },
          { name: "Frøya Kjepso", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/6356cd903dc7f.jpeg", role: "Medlem" },
          { name: "Sukrit Baral", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/6407157190b92.jpeg", role: "Medlem" },
          { name: "Harishsan Arumugadas", image: "https://vektorprogrammet.no/media/cache/profile_img/images/Profile%20photos/64071542a96d0.jpeg", role: "Medlem" }]}
      />
      ...
      <div className="m-3">
        <img className="md:max-w-2xl h-auto content-center mx-auto" src="https://vektorprogrammet.no/images/team_images/20221005_163558.jpg" />
      </div>
      ...
      <div className="font-sans text-lg text-black text-left m-5">
        ...
        tacokveld, 17.mai-feiring, åpent kontor, gokart, minigolf, bumperballs og LazerTag. Jevnlig
        utover semesteret arrangeres det TeamSosialt, der hvert team inviterer to andre team til en
        sosial sammenkomst.
      ...
      <div className="grid md:grid-cols-2 ml-4 mr-4 mt-5 items-center mb-2">
        <div className="font-sans text-lg text-black place-content-start">
          <ul className="ml-10 list-disc">
            ...
            <li>Delta på ukentlige møter med resten av teamet for å diskutere aktuelle saker.</li>
            <li>Delta på konferanser for å promotere Vektorprogrammet for næringslivet.</li>
            <li>Oppdatere resten av Vektorprogrammet når du får en ny avtale.</li>
            <li>Oppdatere sponsorer om hvordan det går med Vektorprogrammet.</li>
      ...
      <div className="font-sans text-lg text-black text-left m-5 place-self-start">
        Vi ser hele tiden etter nye engasjerte medlemmer. Er du interessert, ta kontakt på
        {" "}
        <a
