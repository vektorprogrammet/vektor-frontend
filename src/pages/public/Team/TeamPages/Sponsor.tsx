...
const Sponsor = (): JSX.Element => {
    return (
        <div className="max-w-screen-lg mt-5 mb-20 mx-auto flex flex-col items-center">
            <TeamTemplate name="Sponsor" mail="sponsor.ntnu@vektorprogrammet.no"
            ...
            <div className="m-3">
            <img className="md:max-w-2xl h-auto content-center mx-auto" src="https://vektorprogrammet.no/images/team_images/20221005_163558.jpg"></img>
            </div>
