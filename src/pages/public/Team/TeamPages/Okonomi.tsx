        ...
        <div className="max-w-screen-lg mt-5 mb-20 mx-auto flex flex-col items-center">,
            ...
            <div className="grid md:grid-cols-2 ml-4 mr-4 mt-5 items-center mb-2">
                <div className="m-3">
                    ...
                    Har du noen spørsmål er det bare å ta kontakt med oss på <a className="hover:underline text-vektor-darblue" 
                ...
                <img className="max-h-96 sm:max-w-sm h-auto content-center mx-auto m-3" src="/images/team/OkonomiTor.png"/>
            </div>
