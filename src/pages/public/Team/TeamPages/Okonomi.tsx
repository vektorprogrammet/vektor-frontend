...
const Sponsor = (): JSX.Element => {
    return (
        <div className="max-w-screen-lg mt-5 mb-20 mx-auto flex flex-col items-center">,
            ...
            Økonomiteamet har ansvar for selve pengekassen til Vektorprogrammet. Dette
            innebærer å betale fakturaer i tide og føre regnskap over alle transaksjonene
            som blir utført. I tillegg jobber vi med budsjettet som settes hvert år,
            og følger opp at ingen av regionene overskrider budsjettene sine. Vi er
            en liten gjeng som samarbeider tett med samtlige team, og svarer på
            økonimirelaterte spørsmål ved behov. Arbeidsmengden ligger på rundt
            én-to timer i uken, avhengig av hvor mye som må betales og fikses på.
            </div>
            ...
            <div className="font-sans text-lg text-black text-center m-5">
            Det blir arrangert mange sosiale arrangementer, hvor du kan bli bedre kjent
            med andre teammedlemmer, både innad i økonomitemaet og hele Vektorprogrammet.
            Det varierer etter hva man ønsker å gjøre, men vi har tidligere spist
            tacomiddag og hatt film- og brettkvelder. Etter møtene pleier vi også sitte
            litt igjen på kontoret hvor vi småprater om alt mellom himmel og jord, altså
            en gyllen mulighet til å bli godt kjent med hverandre.
            </div>
            ...
            <div className="font-sans text-lg text-black text-center m-5">
            Vi er på utkikk etter deg som er ansvarlig og strukturert, spesielt med tanke
            på du får delansvaret for alle pengemidlene til Vektorprogrammet. I tillegg
            er det fint om du har et ønske om å lære mer om økonomien knyttet til en
            frivillig organisasjon. Du bør også være interessert i realfag, da vi er
            en organisasjon som kontinuerlig jobber for å fremme mestring innen
            realfag. Kort oppsummert, ønsker vi deg som er interessert i tall og penger.
