  ...
  return (
    <div className="w-full">
      <div className="flex font-medium text-center border-b" role="tablist">
        {divisions.map((data) => {
          const chosenStyle = openTab === data.number ? `border-t-gray-200 border-l-gray-200 border-r-gray-200 border-b-white text-vektor-darblue z-50 dark:bg-neutral-800 dark:text-neutral-200 dark:border-t-white dark:border-l-white dark:border-r-white` : `text-vektor-darblue z-50 dark:hover:bg-neutral-700 dark:border-b-white`;
          return (
      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 border-b-2 border-r-2 border-l-2 px-4 py-5 dark:bg-neutral-800">
