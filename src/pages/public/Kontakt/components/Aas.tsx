...
const Aas = (): JSX.Element => {
  return (
    <>
      <div className="grid grid-cols-2 gap-10">
        <div>
          <div className="font-bold text-2xl text-blue-800">Ås</div>
          <div className="text-base">Norges miljø- og biovitenskapelige universitet</div>
          <br />
          <br />
          <div className="whitespace-nowrap flex space-x-1">
            ...
            <a className="text-sm hover:underline" href="mailto:nmbu@vektorprogrammet.no">nmbu@vektorprogrammet.no</a>
          </div>
        </div>
        <div>
          <div className="divide-y divide-solid">
            ...
            <div className="py-2">
              <div className="text-blue-800">Sponsor og økonomi</div>
              <a className="text-sm hover:underline" href="mailto:sponsor.nmbu@vektorprogrammet.no">sponsor.nmbu@vektorprogrammet.no</a>
            </div>
            <div className="py-2">
              <div className="text-blue-800">Skolekoordinering</div>
              <a className="text-sm hover:underline" href="mailto:skolekoordinering.nmbu@vektorprogrammet.no">skolekoordinering.nmbu@vektorprogrammet.no</a>
            </div>
            <div className="py-2">
              <div className="text-blue-800">Evaluering, Rekruttering og Profilering</div>
              <a className="text-sm hover:underline" href="mailto:evaluering.nmbu@vektorprogrammet.no">evaluering.nmbu@vektorprogrammet.no</a>
            </div>
          </div>
        </div>
      </div>
      <div>
        <div className="font-bold text-2xl text-blue-800 text-center pt-10">Kontakt styret i Ås</div>
        <form>
